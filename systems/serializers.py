...
class SystemVersionSerializer(serializers.ModelSerializer):
  class Meta:
    ...
    'support_sql', 'description_sql','support_foreignkeys',
    'description_foreignkeys','support_serverside','description_serverside',
    'support_mapreduce','description_mapreduce','support_secondary',
    'description_secondary','support_durability','description_durability',
    'support_triggers','description_triggers','support_concurrency',
    'description_concurrency','support_datascheme','description_datascheme',
    'support_xml','description_xml','support_typing','description_typing',
    'support_userconcepts','description_userconcepts',
    'support_transactionconcepts','description_transactionconcepts',
