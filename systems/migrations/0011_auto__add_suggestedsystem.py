...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SuggestedSystem'
        db.create_table(u'systems_suggestedsystem', (
            ...
            ('website', self.gf('django.db.models.fields.URLField')(default='', max_length=200, null=True)),
            ('approved', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'systems', ['SuggestedSystem'])


    def backwards(self, orm):
        # Deleting model 'SuggestedSystem'
        db.delete_table(u'systems_suggestedsystem')
