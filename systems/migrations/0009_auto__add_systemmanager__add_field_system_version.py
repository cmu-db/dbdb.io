...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SystemManager'
        db.create_table(u'systems_systemmanager', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('version_number', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('max_version', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'systems', ['SystemManager'])

        # Adding M2M table for field current_version on 'SystemManager'
        m2m_table_name = db.shorten_name(u'systems_systemmanager_current_version')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('systemmanager', models.ForeignKey(orm[u'systems.systemmanager'], null=False)),
            ('system', models.ForeignKey(orm[u'systems.system'], null=False))
        ))
        db.create_unique(m2m_table_name, ['systemmanager_id', 'system_id'])

        # Adding field 'System.version'
        db.add_column(u'systems_system', 'version',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'SystemManager'
        db.delete_table(u'systems_systemmanager')

        # Removing M2M table for field current_version on 'SystemManager'
        db.delete_table(db.shorten_name(u'systems_systemmanager_current_version'))

        # Deleting field 'System.version'
        db.delete_column(u'systems_system', 'version')
