...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Publication.number'
        db.add_column(u'systems_publication', 'number',
                      self.gf('django.db.models.fields.IntegerField')(default=1, null=True),
                      keep_default=False)

        # Adding field 'Publication.cite'
        db.add_column(u'systems_publication', 'cite',
                      self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Publication.year'
        db.alter_column(u'systems_publication', 'year', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):
        # Deleting field 'Publication.number'
        db.delete_column(u'systems_publication', 'number')

        # Deleting field 'Publication.cite'
        db.delete_column(u'systems_publication', 'cite')
        ...
        # Changing field 'Publication.year'
        db.alter_column(u'systems_publication', 'year', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        u'systems.publication': {
            ...
            'cite': ('django.db.models.fields.TextField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'download': ('django.db.models.fields.URLField', [], {'default': 'None', 'max_length': '200', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'number': ('django.db.models.fields.IntegerField', [], {'default': '1', 'null': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'year': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True'})
        },
