...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'System.description_markup_type'
        db.add_column(u'systems_system', 'description_markup_type',
                      self.gf('django.db.models.fields.CharField')(default='hello', max_length=30),
                      keep_default=False)

        # Adding field 'System._description_rendered'
    ...
    def backwards(self, orm):
        ...
        # Changing field 'System.description'
        db.alter_column(u'systems_system', 'description', self.gf('django.db.models.fields.TextField')())
