# Generated by Django 2.0.3 on 2018-03-16 05:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('website', models.URLField(default=None, max_length=512, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description_citations', models.ManyToManyField(related_name='version_descriptions', to='core.CitationUrl')),
                ('end_year_citations', models.ManyToManyField(related_name='version_end_years', to='core.CitationUrl')),
                ('history_citations', models.ManyToManyField(related_name='version_histories', to='core.CitationUrl')),
            ],
            options={
                'ordering': ('-created',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('derived_from', models.TextField(blank=True, default='', null=True)),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(related_name='version_start_years', to='core.CitationUrl'),
        ),
        migrations.AddField(
            model_name='systemversion',
            name='system',
        ...
        migrations.AddField(
            ...
            name='system',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.SystemVersion'),
        ),
