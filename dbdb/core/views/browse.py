...
class BrowseView(MetadataMixin, View):
    ...
    def do_search(self, get_params, sqs, search_op):
        ...
        if search_name:
            ...
            title_parts.append(f'Named "{search_name}"')

        title = f"Databases {" ".join(title_parts)} "
