...
@register.inclusion_tag("components/_system_link.html")
...
@register.inclusion_tag("components/_org_link.html")
def org_link(org):
    """
...
@register.inclusion_tag("components/_browse_link.html")
...
@register.inclusion_tag("components/_tag_link.html")
...
@register.inclusion_tag("components/_last_modified.html")
