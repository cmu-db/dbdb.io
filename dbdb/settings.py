...
ENRICHMENT_LLM_MODEL          = env('ENRICHMENT_LLM_MODEL',          default='claude-opus-4-8')
ENRICHMENT_LLM_FALLBACK_MODEL = env('ENRICHMENT_LLM_FALLBACK_MODEL', default='qwen3:32b')
CRAWLER_SPAM_CHECKER_MODEL            = env('CRAWLER_SPAM_CHECKER_MODEL', default='qwen3:32b')
CRAWLER_SPAM_CHECKER_FALLBACK_MODEL_A = env('CRAWLER_SPAM_CHECKER_FALLBACK_MODEL_A', default='qwen3:14b')
CRAWLER_SPAM_CHECKER_FALLBACK_MODEL_B = env('CRAWLER_SPAM_CHECKER_FALLBACK_MODEL_B', default='mistral:7b')
CRAWLER_SPAM_VALIDATION_MODEL         = env('CRAWLER_SPAM_VALIDATION_MODEL', default='mistral:7b')
