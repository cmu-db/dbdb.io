    ...
    function editorHtml (content, options) {
        ...
        html += '<div class="md-toolbar">';
            html += '<div class="btn-toolbar">';
                ...
                html += '<div class="btn-group mr-3">';
                    html += '<button type="button" data-mdtooltip="tooltip" title="' + options.label.btnBold + '" class="md-btn btn btn-sm btn-secondary" data-btn="bold"><span class="fa fa-bold"></span></button>';
                    html += '<button type="button" data-mdtooltip="tooltip" title="' + options.label.btnItalic + '" class="md-btn btn btn-sm btn-secondary" data-btn="italic"><span class="fa fa-italic"></span></button>';
                html += '</div>'; // .btn-group

                html += '<div class="btn-group mr-3">';
                    html += '<button type="button" data-mdtooltip="tooltip" title="' + options.label.btnList + '" class="md-btn btn btn-sm btn-secondary" data-btn="ul"><span class="fa fa fa-list"></span></button>';
                    html += '<button type="button" data-mdtooltip="tooltip" title="' + options.label.btnOrderedList + '" class="md-btn btn btn-sm btn-secondary" data-btn="ol"><span class="fa fa-th-list"></span></button>';
                html += '</div>'; // .btn-group

                html += '<div class="btn-group mr-3">';
                    html += '<button type="button" data-mdtooltip="tooltip" title="' + options.label.btnLink + '" class="md-btn btn btn-sm btn-secondary" data-btn="link"><span class="fa fa-link"></span></button>';
                html += '</div>'; // .btn-group

                if (options.fullscreen === true) {
                    html += '<div class="btn-group pull-right">';
                        html += '<button type="button" class="md-btn btn btn-sm btn-secondary" data-btn="fullscreen"><span class="fa fa-arrows-alt"></span> ' + options.label.btnFullscreen + '</button>';
                    html += '</div>'; // .btn-group
                }

                if (options.preview === true) {
                    html += '<div class="btn-group pull-right">';
                        html += '<button type="button" class="md-btn btn btn-sm btn-secondary btn-edit active" data-btn="edit"><span class="fa fa-pencil"></span> ' + options.label.btnEdit + '</button>';
                        html += '<button type="button" class="md-btn btn btn-sm btn-secondary btn-preview" data-btn="preview"><span class="fa fa-eye"></span> ' + options.label.btnPreview + '</button>';
                    html += '</div>'; // .btn-group
                }
